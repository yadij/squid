...
const static uint16_t MaxFramePayloadSz = (2^14);

// ... plus the 9 octet frame header
const static uint16_t MaxFrameDefaultSz = MaxFramePayloadSz + 9;

// SETTINGS_MAX_FRAME_SIZE may extend frame size up to 2^24-1
const static uint16_t MaxFrameExtendedSz = (2^24)-1;
