...
Rock::SwapDir::createStoreIO(StoreEntry &e, StoreIOState::STIOCB *cbIo, void *data)
{
    ...
    IoState *sio = new IoState(self, &e, cbIo, data);
...
StoreIOState::Pointer
Rock::SwapDir::openStoreIO(StoreEntry &e, StoreIOState::STIOCB *cbIo, void *data)
{
    if (!theFile || theFile->error()) {
        debugs(47,4, HERE << theFile);
        return NULL;
